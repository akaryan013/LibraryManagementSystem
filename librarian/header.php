                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a href="send_notification.php"><i class="fa fa-send-o"></i> Send notification <span
                                    class="fa fa-chevron-down"></span></a>

                            </li>
                            <li><a href="books_detail_with_student.php"><i class="fa fa-tasks"></i> Books Issued By Student <span
                                    class="fa fa-chevron-down"></span></a>
